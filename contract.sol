...
contract RealEstate{
    ...
    function getProperty(uint256 _propertyId) public payable{
        Property storage property = properties[_propertyId];

        require(property.forSale==true,"Property not for sale");
        require(property.price<=msg.value,"Price should match, otherwise property cant be bought");
